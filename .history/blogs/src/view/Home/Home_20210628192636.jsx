        ...
        return (
            ...
            <div style={{ padding: "20px" }}>
                ...
                <Descriptions title="Blog Technology Selection">
                    <Descriptions.Item contentStyle={{ fontSize: "1rem" }} span={3} label="前端"><Html5Outlined /> React</Descriptions.Item>
                    <Descriptions.Item contentStyle={{ fontSize: "1rem" }} span={3} label="前端库"><AntDesignOutlined /> Antd</Descriptions.Item>
                    <Descriptions.Item contentStyle={{ fontSize: "1rem" }} span={3} label="后端">Net Core</Descriptions.Item>
                    <Descriptions.Item contentStyle={{ fontSize: "1rem" }} span={3} label="数据库"><ConsoleSqlOutlined /> Mysql</Descriptions.Item>
                    <Descriptions.Item contentStyle={{ fontSize: "1rem" }} span={3} label="服务器"><AliyunOutlined /> 阿里云</Descriptions.Item>
                </Descriptions>
            </div>
